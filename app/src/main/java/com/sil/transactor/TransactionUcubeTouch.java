...
public class TransactionUcubeTouch extends AppCompatActivity implements BatteryLevelListener, SVPPRestartListener, LostPacketListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transaction_ucube_touch);
    ...
    private void initView() {
        ...
        Button scanBtn = findViewById(R.id.new_device_ucube_touch);
    ...
    private void scan() {
      ...
      // String filter = scanFilter.getText().toString();
        intent.putExtra(TransactionUcubeTouch.SCAN_FILTER, "uTouch");
    ...
    public void onLevelChanged(int newLevel) {
        runOnUiThread(() -> Toast.makeText(TransactionUcubeTouch.this, String.format(getString(R.string.battery_level), newLevel), Toast.LENGTH_LONG).show());
        Log.d(TAG,String.format(getString(R.string.battery_level), newLevel));
    }

    @Override
    public void onSVPPRestart() {
        runOnUiThread(() -> UIUtils.showMessageDialog(TransactionUcubeTouch.this, getString(R.string.device_get_stuck)));
        Log.d(TAG, "Notification of SVPP Restart event !");
    }

    @Override
    public void onPacketLost() {
        runOnUiThread(() -> UIUtils.showMessageDialog(TransactionUcubeTouch.this, getString(R.string.lost_packet)));
